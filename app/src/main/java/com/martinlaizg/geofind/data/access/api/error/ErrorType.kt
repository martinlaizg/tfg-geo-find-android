...
enum class ErrorType(val message: Int) {
	...
	ID(R.string.id_error),
	TOUR_ID(R.string.tour_id_error),
	USER_ID(R.string.user_id_error),
	EXIST(R.string.existence_error),
	TOKEN(R.string.token_error),
	PROVIDER(R.string.provider_error),
	PROVIDER_LOGIN(R.string.provider_login_error),
